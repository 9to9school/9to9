    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div class="my-auto mb-2">
                <h3 class="page-title mb-1">Applied List</h3>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Applied List</li>
                    </ol>
                </nav>
            </div>
                            ...
                            <?php $i = 1; ?>
                               @foreach($data as $resume)
                                    <tr>
                                        ...
                                        <td>{{ $resume->vacancy->title ?? 'N/A' }}</td>
                                        <td>
                                            <span class="badge 
                                                @if($resume->status == 'Pending') bg-warning
                                                @elseif($resume->status == 'Shortlisted') bg-success
                                                @elseif($resume->status == 'Rejected') bg-danger
                                                @else bg-secondary
                                            @endif">
                                                {{ $resume->status }}
                                            </span>
                                        </td>
                                        <td><a href="{{ asset($resume->resume) }}" target="_blank">View Resume</a></td>
