    ...
    <div class="content">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
        <div class="my-auto mb-2">
          <h3 class="page-title mb-1">Topic List</h3>
          <nav>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2">
            <a href="{{ route('topic.create') }}" class="btn btn-primary d-flex align-items-center"><i
                class="ti ti-square-rounded-plus me-2"></i>Add Topic</a>
          </div>
        </div>
      </div>
      <!-- /Page Header -->
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img src="{{ asset($topic->image) }}" width="30px"></td>
                  <td>{{ $topic->description }}</td>
                 

                  <td>
                    <span class="badge {{ $topic->status == 1 ? 'badge-success' : 'badge-danger' }}">
                      {{ $topic->status == 1 ? 'Active' : 'Inactive' }}
                    </span>
                  </td>

                  <td>
                    <a href="{{ route('topic.edit', $topic->id) }}" class="btn btn-sm btn-warning">Edit</a>
