                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item">
                            <a href="{{ route('teacher.list') }}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item">
                            Students
                        </li>
                                ...
                                @foreach($students as $student)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary btn-sm"
                                            href="{{ route('pay.fee.list', $student->id) }}">
                                            Pay Fee
                                            </a></td>
                                        <td><a class="btn btn-primary btn-sm"
                                            href="{{ route('activity.pay.list', $student->id) }}">
                                            Activity Fee
                                            </a></td>
                                            <td><a class="btn btn-primary btn-sm"
                                                href="{{ route('daycare.pay.list', $student->id) }}">
                                                Daycare Fee
                                                </a>
                                            </td>
                                            <td><a class="btn btn-primary btn-sm"
                                                href="{{ url('/admin/progress-reports-details/' . $student->id ) }}">
                                                View Progress
                                                </a>
                                            </td>
                                            <td>
                                            <div class="hstack gap-2 fs-15">
                                                <a href="{{ route('student.edit',$student->id)}}" class="btn btn-icon btn-sm btn-light"><i class="ti ti-edit-circle"></i></a>
