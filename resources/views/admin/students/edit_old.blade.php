                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">                                                
                                        <div class="d-flex align-items-center justify-content-center avatar avatar-xxl border border-dashed me-2 flex-shrink-0 text-dark frames position-relative" style="width: 100px; height: 100px;">
                                            @php
                                                $imagePath = !empty($student->student_image) ? asset($student->student_image) : '';
                                            @endphp
                                            <img 
                                                ...
                                                style="{{ empty($student->student_image) ? 'display: none;' : '' }}">
                                                <i id="placeholderIcon"  class="ti ti-photo-plus fs-16 position-absolute top-50 start-50 translate-middle"
                                                style="{{ !empty($student->student_image) ? 'display: none;' : '' }}">
                                               </i>
                                        </div>                                          
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Admission Number</label>
                                         <input type="text" name="admission_number" class="form-control" value="{{ old('academic_year', $student->admission_number) }}" >
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-icon position-relative">
                                            ...
                                            <input type="text"  name="admission_date" class="form-control datetimepicker" value="{{ old('admission_date', $student->admission_date) }}">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="mother_tongue" class="form-control" value="{{ old('mother_tongue', $student->mother_tongue) }}" >
                                    </div>
                                ...
                                <label class="form-label">Phone Number 1</label>
                                    <input type="number" name="phone_number_1" class="form-control" value="{{ old('phone_number_1', $student->phone_number_1) }}">
                                ...
                                <label class="form-label">Phone Number 2</label>
                                    <input type="text" name="phone_number_2" class="form-control" value="{{ old('phone_number_2',$student->phone_number_2) }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="border-top pt-3 d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-end">
                                    ...
                                    <span id="total_per_month_amount" class="ms-2">{{ $student->per_month_fee }}</span>
                                </div>
                            </div>
