                                ...
                                <div class="row sibling-cont mb3" data-count="0" data-last-admission="9T90625071500006">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="student_id[0]" class="form-control student_id_0" readonly>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="admission_number[0]" class="form-control admission_number_0" readonly>
...
$(".add-child").on('click', function () {
    ...
    <div class="col-md-6 mb-3">
        ...
        <select name="school_id[${index}]" class="form-select select2 select-school">
            <option value="">--Select School--</option>
                ${schools}
        </select>
    </div>
...
$('.addsibling-info').on('change', '.age-select', function () {   
    ...
    if (popular_id) {
        $.ajax({
            url: '/admin/get-topics-by-age/' + popular_id,
            type: 'GET',
     ...
     if (popular_id) {
        $.ajax({
            url: '{{ url("admin/get-subtopics-by-topic") }}/' + popular_id,
            type: 'GET',
            success: function (data) {
...
//     if (school_id_raw) {
//         // Pad school id to 2 digits with leading zero
...
//                     let admissionNumber = res.admission_id; // e.g. 9T90725071500006
...
//                 type: 'GET',
//                 success: function (res) {
//                     let admissionNumber = res.student_id; // e.g. 9T90725071500006
//                     parentRow.find(`input[name="student_id[${dataCount}]"]`).val(admissionNumber);
//                 },
//                 error: function () {
...
//                 // Explanation: total length - prefix(3) - school_id(2) - nextId(5) = datePart length

//                 // Extract datePart from previous admission number:
//                 let datePartStart = fixedPrefix.length + 2;  // after 9T9 and schoolId(2)
//                 let datePart = prevAdmission.substr(datePartStart, datePartLength);

//                 // Compose prefix same as PHP: 9T9 + padded schoolId + datePart
//                 let prefix = fixedPrefix + schoolIdStr + datePart;

//                 // Extract suffix (last 5 digits)
...
//             let prevCount = dataCount - 1;
//             let prevAdmission = $(`input[name="student_id[${prevCount}]"]`).val();

//             if (prevAdmission) {
//                 // Use same prefix as PHP: "STU-"
//                 let fixedPrefix = "STU-";

//                 // Ensure schoolId is 2-digit padded
//                 let schoolIdStr = schoolId.toString().padStart(2, '0');

//                 // Extract date part (6 digits) from previous admission number (after STU- and schoolId)
//                 let datePartStart = fixedPrefix.length + 2; // STU- + 2 digits of schoolId
//                 let datePart = prevAdmission.substr(datePartStart, 6); // yymmdd

//                 // Compose prefix: STU- + schoolIdStr + datePart
//                 let prefix = fixedPrefix + schoolIdStr + datePart;

//                 // Get last 4-digit sequence and increment
//                 let suffix = prevAdmission.substr(prevAdmission.length - 4);
//                 let nextSuffixNum = parseInt(suffix, 10) + 1;
//                 let nextSuffix = nextSuffixNum.toString().padStart(4, '0');

//                 let nextAdmission = prefix + nextSuffix;

//                 parentRow.find(`input[name="student_id[${dataCount}]"]`).val(nextAdmission);
//             } else {
//                 alert('Previous admission number missing. Please fill the first one first.');
//             }
//         }
