                        ...
                        <div class="card-body pb-1">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <!-- <input type="number" name="academic_year" class="form-control" placeholder="e.g., June 2025/26" id ="academic_year" value="{{ old('academic_year') }}"> -->
                                    <select
                                        name="academic_year"
                                        id="academic_year"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Admission Number</label>
                                         <input type="text" name="admission_number" class="form-control"  readonly value="" id ="admission_number">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-icon position-relative">
                                            ...
                                            <input type="text"  name="admission_date" class="form-control datetimepicker" id ="admission_date" value="{{ old('admission_date') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="primary_contact" class="form-control" id ="primary_contact" value="{{ old('primary_contact') }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="mother_tongue" class="form-control" id ="mother_tongue" value="{{ old('mother_tongue') }}">
                                    </div>
                                ...
                                <label class="form-label">Phone Number 1</label>
                                    <input type="number" name="phone_number_1" class="form-control" id="phone_number_1" value="{{ old('phone_number_1') }}">
                                ...
                                <label class="form-label">Phone Number 2</label>
                                    <input type="text" name="phone_number_2" class="form-control" id="phone_number_2" value="{{ old('phone_number_2') }}">
...
$('#school_id').on('change', function () {
    ...
    if (schoolId) {
        $.ajax({
             url: "{{url('/admin/generate-admission-id')}}/" + schoolId,
            method: 'GET',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            },
            success: function (response) {
                $('#admission_number').val(response.admission_id);
            }
        });
    } else {
