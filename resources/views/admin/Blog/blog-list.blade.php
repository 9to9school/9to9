    ...
    <div class="content">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2">
            <a href="{{ url('admin/add-blog') }}" class="btn btn-primary d-flex align-items-center"><i
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($blog->image)
                    <img src="{{ asset($blog->image) }}" width="50" height="50" alt="Blog Image">
                    @else
                    No Image
                    @endif
                  </td>
                  <td>{{ Str::limit($blog->description, 50) }}</td>
                  <td>{{ $blog->button_name }}</td>
                  <td>
                    @if($blog->button_link)
                    <a href="{{ $blog->button_link }}" target="_blank">Buuton Link</a>
                    @else
                    N/A
                    @endif
                  </td>
                  <td>{{ $blog->short_summary }}</td>
                  <td>{{ $blog->meta_type }}</td>
                  <td>
                  ...
                  <td>
                    <a href="{{ url('admin/add-blog/' .$blog->id) }}" class="btn btn-sm btn-warning">Edit</a>
                  </td>
                </tr>
                @endforeach
