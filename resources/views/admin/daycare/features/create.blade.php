...
@section('title', 'Add Daycare Feature')
@section('content')
  ...
  <div class="content content-two">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="{{ route('daycare.feature.store')}}" method="POST">
          @csrf
          ...
          <div class="card">
            <div class="card-header bg-light">
              <div class="d-flex align-items-center">
                ...
                <h4 class="text-dark">Add Daycare Feature</h4>
              </div>
            </div>
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <select name="hour" class="form-control">
                      ...
                      @for ($i = 1; $i <= 15; $i++)
                        <option value="{{ $i }}" {{ old('hour') == $i ? 'selected' : '' }}>{{ $i }}</option>
                      @endfor
                    </select>
