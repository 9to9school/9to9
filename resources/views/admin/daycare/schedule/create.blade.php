                ...
                <div class="my-auto mb-2">
                    ...
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('daycare.schedule.index') }}">Daycare  Schedule</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Add Daycare  Schedule</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    @php
                        ...
                        $action = $isEdit ? route('daycare.schedule.update', $data->id) : route('daycare.schedule.store');
                    @endphp
                        ...
                        <div class="card">
                            <div class="card-header bg-light">
                                ...
                                <span class="bg-white avatar avatar-sm me-2 text-gray-7 flex-shrink-0">
                                    ...
                                    <h4 class="text-dark">Add Daycare  Schedule</h4>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="timing" class="form-control" value="{{ old('timing', $data->timing ?? '') }}">
                                            @error('timing')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">Save Daycare  Schedule</button>
                            </div>
                        </div>
                    </form>
                </div>
