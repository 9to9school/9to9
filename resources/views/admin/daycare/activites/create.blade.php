                ...
                <div class="my-auto mb-2">
                    ...
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('daycare.activites.index') }}">Daycare Activites</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Add Daycare Activites</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    @php
                        ...
                        $action = $isEdit ? route('daycare.activites.update', $data->id) : route('daycare.activites.store');
                    @endphp
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pb-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">Upload Image 782*485<span class="text-danger">*</span></label>
