...
@section('title', 'Add Daycare Skills')
@section('content')
        ...
        <div class="content content-two">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                <div class="my-auto mb-2">
                    <h3 class="mb-1">Add Daycare Skills</h3>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('daycare.skills.index') }}">Daycare </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Add Daycare Skills</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    @php
                        ...
                        $action = $isEdit ? route('daycare.skills.update', $data->id) : route('daycare.skills.store');
                    @endphp
                        ...
                        <div class="card">
                            <div class="card-header bg-light">
                                ...
                                <span class="bg-white avatar avatar-sm me-2 text-gray-7 flex-shrink-0">
                                    ...
                                    <h4 class="text-dark">Add Daycare Skills</h4>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">Save  Daycare Skills</button>
                            </div>
                        </div>
                    </form>
                </div>
