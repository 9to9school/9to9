...
<div class="page-wrapper">
    <div class="content content-two">
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('partner.gallery.list') }}">Galleries</a>
                        </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('partner.gallery.post')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            <div class="d-flex align-items-center">
                                ...
                                <h4 class="text-dark">Gallery Information</h4>
                            </div>
                        </div>
                        <div class="card-body pb-1">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                                        ...
                                        <div class="profile-upload">
                                            <div class="profile-uploader d-flex align-items-center">
                                                <input type="file" name="gallery_image" class="form-control"  onchange="previewStudentImage(event)">
                                            </div>
                            ...
                            <div class="text-end mt-3">
                                <a href="{{ route('school.gallery.list') }}" class="btn btn-light me-3">Cancel</a>
