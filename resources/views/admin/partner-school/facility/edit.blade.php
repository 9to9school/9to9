    ...
    <div class="content content-two">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div class="my-auto mb-2">
                <h3 class="mb-1">Edit Facility</h3>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('partner.facility.list') }}">Facilities</a>
                        </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('partner.facility.update')}}" method="POST" enctype="multipart/form-data">
                               ...
                               {{--<div class="col-md-6 mb-3">
                                    ...
                                    >
                                        ...
                                        @foreach($schools as $school)
                                            <option
                                                value="{{ $school->id }}" {{ $getdata->school_id == $school->id ? 'selected' : '' }}
                                                >
                                                {{ $school->school_name }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="" value="{{$getdata->name}}">
                                        @if ($errors->has('name'))
