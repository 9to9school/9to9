                  ...
                  <div class="col-lg-3 col-md-6">
                    <div class="mb-3">
                      <div class="d-flex align-items-center">
                        <div class="w-100">
                          <label class="form-label">Annual Fees</label> 
                           <input type="number" name="annual_fees[]" class="form-control" id="ann_amount_0">
                        </div>
                        <div>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="mb-3">
            <div class="d-flex align-items-center">
              <div class="w-100">
                <label class="form-label">Annual Fees</label> 
                  <input type="number" name="annual_fees[]" class="form-control" id="ann_amount_${siblingCounter}">
              </div>
              <div>
                <label class="form-label">&nbsp;</label>
                <a href="javascript:void(0);" class="trash-icon ms-3"><i class="ti ti-trash-x"></i></a>
