...
<div class="content">
    ...
    <div class="my-auto mb-2">
        <h3 class="page-title mb-1">Contents List</h3>
        <nav>
    ...
    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
        ...
        @endphp
        <div class="mb-2">
        <a href="{{ url('admin/add-content',$lifeHackId) }}" class="btn btn-primary d-flex align-items-center"><i
            class="ti ti-square-rounded-plus me-2"></i>Add Content</a>
        </div>
    </div>
    </div>
    <!-- /Page Header -->
    ...
    <div class="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
        <h4 class="mb-3">Contents List</h4>
                ...
                @if($content)
                    @foreach($content as $data)
                        <tr>
                            ...
                            <td>
                                @if($data->image)
                                    <img src="{{ asset($data->image) }}" width="50" height="50" alt="Blog Image">
                                @else
                                    No Image
                                @endif
                            </td>
                            ...
                            <td>
                                <a href="{{ url('admin/edit-content/' . $data->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                 <a href="#" class="btn btn-sm btn-danger" onclick="deleteConfirmation({{$data->id}})">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                @endif
...
swal({
    ...
    if (e.value === true) {
        ...
        $.ajax({
            type: 'get',
            url: "{{url('/admin/content-delete')}}/" + id,
