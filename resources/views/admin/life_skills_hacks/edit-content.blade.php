  ...
  <div class="content content-two">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
      <div class="my-auto mb-2">
        <h3 class="mb-1">Edit Life Skill Hack Contents  Content</h3>
        <nav>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="{{ url('/admin/update-content/' . ($data->id ?? '')) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('POST')
              ...
              <div class="col-md-12">
                      ...
                      <div class="me-3">
                        <div class="preview-box border border-dashed rounded d-flex align-items-center justify-content-center" style="width: 150px; height: 150px; position: relative; overflow: hidden;">
                          <img
                              ...
                              alt="Preview"
                              style="{{ $data->image ? '' : 'display:none;' }} width: 100%; height: 100%; object-fit: cover; border-radius: 10px;"
                            />
                          <i class="ti ti-photo-plus fs-24 text-muted" id="upload-icon" style="position: absolute; {{ $data->image ? 'display:none;' : '' }}"></i>
                        </div>
                      </div>
                      <div>
                        <label for="image" class="form-label">Upload Image 800*450</label>
                         <input type="file" name="image" id="image" class="form-control" value="{{ old('image', $data->image ?? '') }}" accept="image/*">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <textarea id="editor" rows="5" name="description">{{ old('description', $data->description ?? '') }}</textarea>
                    @error('description')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
