...
<div class="page-wrapper">
    <div class="content content-two">
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Habit</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('habit.post')}}" method="POST" enctype="multipart/form-data">
                    @csrf
