...
<div class="page-wrapper">
    <div class="content content-two">
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('habit.list') }}">Habits</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Habit</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('habit.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            <div class="d-flex align-items-center">
                                ...
                                <h4 class="text-dark">Habit Information</h4>
                            </div>
                        </div>
                        <div class="card-body pb-1">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Habit Name<span style="color: red">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="type" class="form-control" id="status">
                                        ...
                                        <option value="good" {{  $getdata->type === 'good'   ? 'selected' : '' }}>Good</option>
                                        <option value="bed"{{  $getdata->type === 'bed'   ? 'selected' : '' }}>Bed</option>
                                    </select>
                                    @if ($errors->has('type'))
                            ...
                            <div class="text-end mt-3">
                                <a href="{{ route('habit.list') }}" class="btn btn-light me-3">Cancel</a>
...
function previewStudentImage(event) {
    ...
    const previewImg = document.getElementById('HabitImagePreview');
