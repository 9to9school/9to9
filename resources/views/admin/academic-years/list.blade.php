    ...
    <div class="content">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
        <div class="my-auto mb-2">
          <h3 class="page-title mb-1">Academic Year List</h3>
          <nav>
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">All Academic Year</li>
            </ol>
          </nav>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2">
            <a href="{{ route('academic.create') }}" class="btn btn-primary d-flex align-items-center"><i
                class="ti ti-square-rounded-plus me-2"></i>Add Academic Year</a>
          </div>
        </div>
      </div>
      <!-- /Page Header -->
        ...
        <tbody>
            @foreach($academicYears as $academicYear)
                <tr>
                    ...
                    <td>{{ $academicYear->academic_number }}</td>
                    <td>
                        <span class="badge {{ $academicYear->status == 'active' ? 'badge-success' : 'badge-danger' }}">
                            {{ ucfirst($academicYear->status) }}
                        </span>
                    </td>
                    <td>
                        <a href="{{ route('academic.edit', $academicYear->id) }}" class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('academic.destroy', $academicYear->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
