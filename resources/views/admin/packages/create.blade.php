...
@section('content')
    <div class="page-wrapper">
        <div class="content content-two">
            ...
            <div class="col-md-12">
                <form action="{{ url('admin/package/' . ($package->id ?? '')) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                        ...
                        <div class="card-body pb-1">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="title" value="{{$package->title}}" class="form-control" placeholder="Title Name">
                                    @error('heading') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Url <span class="text-danger">*</span></label>
                                    <input type="text" name="url" value="{{$package->url}}" class="form-control" placeholder="Title Url">
                                    @error('heading') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <!-- Upload Image -->
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="banner_heading" value="{{$package->banner_heading}}" class="form-control" placeholder="Banner Heading">
                                    @error('heading') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
