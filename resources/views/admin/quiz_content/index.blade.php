                    ...
                    <div class="card-body p-0 py-3">
                        ...
                        <div class="custom-datatable-filter table-responsive">
                            <table class="table datatable">
                                ...
                                <tbody>
                                @foreach($quizContents as $key => $quiz)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>
                                            <img src="{{ asset($quiz->image) }}" width="70" alt="{{ $quiz->heading }}">
                                        </td>
                                        <td>{{ $quiz->heading }}</td>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/quiz-content', $quiz->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                            <form action="{{ url('admin/life-skills-quiz/'.$quiz->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
