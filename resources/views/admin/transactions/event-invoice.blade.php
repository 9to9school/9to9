...
<div class="page-wrapper">
  <div class="content" style="font-family: 'Roboto', sans-serif;">
    ...
    <?php 
     $data = \App\Models\School::find($eventdata->school_id);
    ?>
      <!-- Logo and Header -->
      <div class="flex items-center justify-between mb-6">
        ...
        @php
            ...
            $EventId = $eventdata->activity_id ?? '000';
        @endphp

        <div class="text-right text-gray-700">
          <p><span class="font-semibold">Invoice #:</span> INV-{{ $currentDate }}-000{{ $EventId }}</p>
      ...
      <div class="mb-4">
        ...
        <p>{{ $eventdata->city }}, {{ $eventdata->state }} {{ $eventdata->pincode }}</p>
      ...
      <table class="w-full border-collapse border border-gray-300 mb-6">
        ...
        <tbody>
          <tr>
            <td class="border border-gray-300 px-3 py-2">{{ \App\Models\Event::find($eventdata->activity_id)?->event_name ?? '' }}</td>
            <td class="border border-gray-300 px-3 py-2 text-right">₹{{ $eventdata->fees }}</td>
          </tr>
        </tbody>
      </table>
