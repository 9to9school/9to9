    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div class="my-auto mb-2">
                <h3 class="page-title mb-1">Event Transaction List</h3>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Event Transaction List</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                <h4 class="mb-3">Event Transaction List</h4>
                            ...
                            <?php $i = 1; ?>
                                @foreach($eventdata as $data)
                                    <tr>
                                        <td>{{$i}}</td>
                                        <td>{{ $data->order_id }}</td>
                                        <td>{{ \App\Models\Event::find($data->activity_id)?->event_name ?? '' }}</td>
                                        <td>{{ $data->name }}</td>
                                        <td>₹ {{ $data->fees }} </td>
                                        <?php 
                                        if($data->status == 'paid'){
                                        ...
                                        <td>
                                            <a href="{{ route('event.invoice', $data->id) }}" class="btn btn-sm btn-warning">view Invoice</a>
