...
@section('title', 'Fees Transaction List')
    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div class="my-auto mb-2">
                <h3 class="page-title mb-1">Fees Transaction List</h3>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Fees Transaction List</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                <h4 class="mb-3">Fees Transaction List</h4>
                            ...
                            <?php $i = 1; ?>
                                @foreach($studentdata as $data)
                                    <tr>
                                        <td>{{$i}}</td>
                                        <td>{{ $data->order_id }}</td>
                                        <td>{{ \App\Models\Student::find($data->student_id)?->first_name ?? '' }} {{ \App\Models\Student::find($data->student_id)?->last_name ?? '' }}</td>
                                        ...
                                        <td>{{ optional($data->date)->format('d M Y') }} </td>
                                        <td>
                                            <a href="{{ route('fee.invoice', $data->id) }}" class="btn btn-sm btn-warning">view Invoice</a>
