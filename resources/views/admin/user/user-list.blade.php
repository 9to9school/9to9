    ...
    <div class="content">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
        <div class="my-auto mb-2">
          <h3 class="page-title mb-1">User List</h3>
          <nav>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2">
            <a href="{{ route('user.create') }}" class="btn btn-primary d-flex align-items-center"><i
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($user->avtar)
                    <img src="{{ asset($user->avtar) }}" width="50" height="50" alt="School Image">
                    @else
                    No Image
                    @endif
                  </td>
