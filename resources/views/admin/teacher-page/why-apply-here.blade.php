            ...
            <div class="content">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                        ...
                        <div class="mb-2">
                            <a href="{{ url('admin/teacher-why-apply-here') }}" class="btn btn-primary d-flex align-items-center">
                                <i class="ti ti-square-rounded-plus me-2"></i>{{$title}}
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table datatable">
                                ...
                                @foreach($data as $key =>$row)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>
                                            <img src="{{ asset($row->image) }}" width="70" alt="{{ $row->title }}">
                                        </td>
                                        <td>{{ $row->title }}</td>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/teacher-why-apply-here', $row->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
