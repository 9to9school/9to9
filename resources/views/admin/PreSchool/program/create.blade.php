        ...
        <div class="content content-two">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                <div class="my-auto mb-2">
                    <h3 class="mb-1">{{$page_name}} Pre Program</h3>
                    <nav>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                        ...
                        @php
                            $isEdit = isset($data);
                            $action = $isEdit ? route('pre.program.update', $data->id) : route('pre.program.store');
                        @endphp
                        ...
                        <div class="card">
                            <div class="card-header bg-light">
                                ...
                                <span class="bg-white avatar avatar-sm me-2 text-gray-7 flex-shrink-0">
                                    ...
                                    <h4 class="text-dark">{{$page_name}} Pre Program</h4>
                                </div>
                            </div>
