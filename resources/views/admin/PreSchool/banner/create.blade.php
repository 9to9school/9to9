...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content content-two">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ url('admin/pre-banner/' . ($webbanner->id ?? '')) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($banners as $banner)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('admin/pre-banner/'.$banner->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
