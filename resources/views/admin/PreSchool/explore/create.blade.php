        ...
        <div class="content content-two">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                <div class="my-auto mb-2">
                    <h3 class="mb-1">{{ $page_name }} Pre Explore</h3>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('pre.explore.index') }}">Pre Explore List</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{$page_name}}  Pre Explore</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    @php
                        $isEdit = isset($data);
                        $action = $isEdit ? route('pre.explore.update', $data->id) : route('pre.explore.store');
                    @endphp
                        ...
                        <div class="card">
                            <div class="card-header bg-light">
                                ...
                                <span class="bg-white avatar avatar-sm me-2 text-gray-7 flex-shrink-0">
                                    ...
                                    <h4 class="text-dark">{{ $page_name }}  Pre Explore</h4>
                                </div>
                            </div>
                                           ...
                                           <div class="row">
                                               ...
                                               <div class="col-md-4">
                                                   <div class="mb-3">
                                                       ...
                                                       <input type="text" name="button_name" class="form-control" value="{{ old('button_name', $data->button_name ?? '') }}">
                                                       @error('button_name')
                                                       <span class="text-danger">{{ $message }}</span>
                                                       @enderror
                                                   </div>
                                               ...
                                               <div class="col-md-4">
                                                   <div class="mb-3">
                                                       ...
                                                       <input type="text" name="button_link" class="form-control" value="{{ old('button_link', $data->button_link ?? '') }}">
                                                       @error('button_link')
                                                       <span class="text-danger">{{ $message }}</span>
                                                       @enderror
                                                   </div>
                                               ...
                                               <div class="col-md-4">
                                                   <div class="mb-3">
                                                       <label class="form-label">Upload Image 660*620<span class="text-danger">*</span></label>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">{{ $isEdit ? 'Update' : 'Save' }} Pre Explore</button>
                            </div>
                        </div>
                    </form>
                </div>
