        ...
        <div class="content content-two">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                <div class="my-auto mb-2">
                    <h3 class="mb-1">Add Pre Safety</h3>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('pre.explore.index') }}">Pre Safety</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Add Pre Safety</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    @php
                        $isEdit = isset($data);
                        $action = $isEdit ? route('pre.safety.update', $data->id) : route('pre.safety.store');
                    @endphp
                        ...
                        <div class="card">
                            <div class="card-header bg-light">
                                ...
                                <span class="bg-white avatar avatar-sm me-2 text-gray-7 flex-shrink-0">
                                    ...
                                    <h4 class="text-dark">Add Pre Safety</h4>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="color" name="color" class="form-control" value="{{ old('color',  $data->color ?? '') }}">
                                            @error('color')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-2 mb-3 text-center">
                                        <div class="d-flex justify-content-center">
                                            <img id="preview-image" src="{{ asset($data->image ?? 'no-image.png') }}" alt="Preview" style="max-height: 200px; border: 1px dashed #ccc; padding: 10px;">
                                        </div>
                                    </div>
