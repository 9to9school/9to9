    ...
    <div class="content">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
        <div class="my-auto mb-2">
          <h3 class="page-title mb-1">Event List</h3>
          <nav>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2">
            <a href="{{ url('admin/event') }}" class="btn btn-primary d-flex align-items-center"><i
                class="ti ti-square-rounded-plus me-2"></i>Add Events</a>
          </div>
        </div>
      </div>
      <!-- /Page Header -->
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{ $event->id }}</td>
                  <td>
                    <img src="{{asset($event->image)}}" alt="{{$event->event_name}}" width="100px">
                  </td>
                  <td>
                    {{$event->event_name}}
                  </td>
                  ...
                  <td>
                    <span class="badge {{ $event->status ? 'badge-success' : 'badge-danger' }}">
                      {{ $event->status ? 'Active' : 'Inactive' }}
                    </span>
                  </td>
                  <td>
                    <div class="hstack gap-2 fs-15">
                        <a href="{{ url('admin/event', $event->id) }}" class="btn btn-icon btn-sm btn-light"><i class="ti ti-edit-circle"></i></a>
                        <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-light" onclick="deleteConfirmation({{$event->id}})"><i class="ti ti-trash-x"></i></a>
                    </div> 
                  </td>
                </tr>
                @endforeach
...
swal({
    ...
    if (e.value === true) {
        ...
        $.ajax({
            type: 'get',
            url: "{{url('/admin/delete-events')}}/" + id,
