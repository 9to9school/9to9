    ...
    <div class="content content-two">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div class="my-auto mb-2">
                <h3 class="mb-1">Add Programme</h3>
                <nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('programme.post')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card-body pb-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="no_of_teacher" class="form-control">
