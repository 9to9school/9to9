        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('product.update')}}" method="POST" enctype="multipart/form-data">
                    <input type="hiddden" value="{{ $getdata->id }}" name="id">
                    @csrf
                        ...
                        <div class="card-body pb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                                        <div class="d-flex align-items-center justify-content-center avatar avatar-xxl border border-dashed me-2 flex-shrink-0 text-dark frames">
                                             <img id="productImagePreview" src="{{ asset($image) }}" alt="Preview" style="max-height: 100px; display: none;" class="img-fluid">

                                        <i id="placeholderIcon" class="ti ti-photo-plus fs-16"></i>
                                        </div>
                                        <div class="profile-upload">
                                            <div class="profile-uploader d-flex align-items-center">
                                                <input type="file" name="product_image" class="form-control"  onchange="previewStudentImage(event)">
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="product_name" class="form-control" value="{{ $getdata->name }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="price" class="form-control" value="{{$getdata->price}}">
                                    @if ($errors->has('price'))
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="mrp" class="form-control" value="{{$getdata->mrp}}">
                                    @if ($errors->has('mrp'))
                            ...
                            <div class="text-end mt-3">
                                <a href="{{ route('product.list') }}" class="btn btn-light me-3">Cancel</a>
