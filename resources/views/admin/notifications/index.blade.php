        ...
        <div class="content content-two">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                <div class="my-auto mb-2">
                    <h3 class="page-title mb-1">Notification List</h3>
                    <nav>
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                    ...
                    <div class="mb-2">
                        <a href="{{ url('admin/notifications/create') }}" class="btn btn-primary d-flex align-items-center"><i
                                    class="ti ti-square-rounded-plus me-2"></i>Add notifications</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
...
{{--                                        <th>Status</th>--}}
                                    ...
                                    <tbody>
                                    @foreach($notifications as $banner)
                                        <tr>
                                            <td>{{ $banner->id }}</td>
                                            <td>{{ $banner->title }}</td>
                                            <td>
...
{{--                                            </td>--}}
                                            ...
                                            <td>
                                                <a href="{{ url('admin/notifications/'. $banner->id. '/edit/') }}" class="btn btn-sm btn-warning">Edit</a>
                                                <form action="{{ route('notifications.destroy', $banner->id) }}" method="POST" style="display:inline;">
