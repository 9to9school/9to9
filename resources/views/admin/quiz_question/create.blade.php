                    ...
                    <div class="card-body pb-1">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="option2" value="{{ old('option2') }}" class="form-control" placeholder="Option 2">
                                @error('option2') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label">Option 3</label>
                                <input type="text" name="option3" value="{{ old('option3') }}" class="form-control" placeholder="Option 3">
                                @error('option3') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label">Option 4</label>
                                <input type="text" name="option4" value="{{ old('option4') }}" class="form-control" placeholder="Option 4">
