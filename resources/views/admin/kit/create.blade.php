...
<div class="page-wrapper">
    <div class="content content-two">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('kit.post')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pb-1">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                                        <div class="d-flex align-items-center justify-content-center avatar avatar-xxl border border-dashed me-2 flex-shrink-0 text-dark frames">
                                             <img id="KitImagePreview" src="" alt="Preview" style="max-height: 100px; display: none;" class="img-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="age" class="select2" multiple="multiple">
                                        ...
                                        <option value="{{$agedata->title}}">{{$agedata->title}}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('age'))
                            ...
                            <div class="text-end mt-3">
                                ...
                                <button type="submit" class="btn btn-primary">Add Kit</button>
                            </div>
                        </div>
                    </div>
                    <!-- /Kit Information -->
