...
<div class="page-wrapper">
    <div class="content content-two">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('teacher.vacancy.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="shift[]" class="form-control select2">
                                            ...
                                            @foreach ($shifts as $shift)
                                                <option value="{{ $shift->id }}" {{ (collect(old('shift'))->contains($shift->id)) ? 'selected' : '' }}>{{ $shift->time_from }} - {{ $shift->time_to }}</option>
                                            @endforeach
                                        </select> 
                                        @if ($errors->has('shift'))
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="opening" class="form-control" placeholder="">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="student" class="form-control" placeholder="">
