    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div class="my-auto mb-2">
                <h3 class="page-title mb-1">Vacancy List</h3>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">All Vacancy</li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                ...
                <div class="mb-2">
                    <a href="{{ route('teacher.vacancy.create')}}" class="btn btn-primary d-flex align-items-center"><i
                            class="ti ti-square-rounded-plus me-2"></i>Add Vacancy</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hstack gap-2 fs-15">
                                                <a href="{{route('teacher.vacancy.edit', $data->id)}}" class="btn btn-icon btn-sm btn-light"><i class="ti ti-edit-circle"></i></a>
...
swal({
    ...
    if (e.value === true) {
        ...
        $.ajax({
            type: 'get',
            url: "{{url('/school/vacancy-delete')}}/" + id,
