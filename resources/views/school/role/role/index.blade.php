    ...
    <div class="content">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
        <div class="my-auto mb-2">
          <h3 class="page-title mb-1">Roles List</h3>
          <nav>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2">
            <a href="{{ route('school.role.create')}}" class="btn btn-primary d-flex align-items-center"><i
                      class="ti ti-square-rounded-plus me-2"></i>Add Roles</a>
          </div>
        </div>
      </div>
      <!-- /Page Header -->
              ...
              <tbody>
                ...
                @if(!empty($role))
                    ...
                    <tr>
                     ...
                     <td><a href="{{ route('school.role.edit', $roles->id) }}" class="btn btn-sm btn-warning">Edit</a>
                      <button type="submit" class="btn btn-sm btn-danger" onclick="deleteConfirmation({{$roles->id}})">Delete</button>
                    </td>
        ...
        function deleteConfirmation(id) {
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{url('/school/delete-roles')}}/" + id,
