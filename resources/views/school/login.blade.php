...
<head>
  ...
  <title>9to9Schools School Admin</title>
  ...
  <!-- Feather CSS -->
  <link rel="stylesheet" href="https://preskool.dreamstechnologies.com/html/template/assets/plugins/icons/feather/feather.css">

  <!-- Tabler Icon CSS -->
  <link rel="stylesheet" href="https://preskool.dreamstechnologies.com/html/template/assets/plugins/tabler-icons/tabler-icons.css">

  <!-- Fontawesome CSS -->
  <link rel="stylesheet" href="https://preskool.dreamstechnologies.com/html/template/assets/plugins/fontawesome/css/fontawesome.min.css">
  <link rel="stylesheet" href="https://preskool.dreamstechnologies.com/html/template/assets/plugins/fontawesome/css/all.min.css">

  <!-- Select2 CSS -->
  <link rel="stylesheet" href="https://preskool.dreamstechnologies.com/html/template/assets/plugins/select2/css/select2.min.css">
...
<body class="account-page">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
              <div class="col-md-8 mx-auto p-4">
                <form action="{{ route('school.post') }}" method="POST">
  ...
  <!-- jQuery -->
  <script src="https://preskool.dreamstechnologies.com/html/template/assets/js/jquery-3.7.1.min.js" type="cc23bd34224afba88ff4e115-text/javascript">
  </script>

  <!-- Bootstrap Core JS -->
  <script src="https://preskool.dreamstechnologies.com/html/template/assets/js/bootstrap.bundle.min.js" type="cc23bd34224afba88ff4e115-text/javascript">
  </script>

  <!-- Feather Icon JS -->
  <script src="https://preskool.dreamstechnologies.com/html/template/assets/js/feather.min.js" type="cc23bd34224afba88ff4e115-text/javascript"></script>

  <!-- Slimscroll JS -->
  <script src="https://preskool.dreamstechnologies.com/html/template/assets/js/jquery.slimscroll.min.js" type="cc23bd34224afba88ff4e115-text/javascript">
  </script>

  <!-- Select2 JS -->
  <script src="https://preskool.dreamstechnologies.com/html/template/assets/plugins/select2/js/select2.min.js"
    type="cc23bd34224afba88ff4e115-text/javascript"></script>

  <!-- Custom JS -->
  <script src="https://preskool.dreamstechnologies.com/html/template/assets/js/script.js" type="cc23bd34224afba88ff4e115-text/javascript"></script>
