    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                ...
                <div class="mb-2">
                    <a href="{{ route('school.facility.add')}}" class="btn btn-primary d-flex align-items-center"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hstack gap-2 fs-15">
                                                <a href="{{route('school.facility.edit', $data->id)}}" class="btn btn-icon btn-sm btn-light"><i class="ti ti-edit-circle"></i></a>
...
swal({
    ...
    if (e.value === true) {
        ...
        $.ajax({
            type: 'get',
            url: "{{url('/school/delete-facility')}}/" + id,
