    ...
    <section class=" bg-[#F4F7FE] text-[#1E293B] px-4 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition">
                ...
                <h3 class="text-lg font-semibold mb-1">{{$franchise->why_choose_heading}}</h3>
                <p class="text-sm text-gray-600">{{$franchise->why_choose_para}}</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition">
                ...
                <h3 class="text-lg font-semibold mb-1">{{$franchise->why_choose_heading1}}</h3>
                <p class="text-sm text-gray-600">{{$franchise->why_choose_para1}}</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition">
                ...
                <h3 class="text-lg font-semibold mb-1">{{$franchise->why_choose_heading2}}</h3>
                <p class="text-sm text-gray-600">{{$franchise->why_choose_para2}}</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition">
                ...
                <h3 class="text-lg font-semibold mb-1">{{$franchise->why_choose_heading3}}</h3>
                <p class="text-sm text-gray-600">{{$franchise->why_choose_para3}}</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition">
                ...
                <h3 class="text-lg font-semibold mb-1">{{$franchise->why_choose_heading4}}</h3>
                <p class="text-sm text-gray-600">{{$franchise->why_choose_para4}}</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition">
                ...
                <h3 class="text-lg font-semibold mb-1">{{$franchise->why_choose_heading5}}</h3>
                <p class="text-sm text-gray-600">{{$franchise->why_choose_para5}}</p>
            </div>
        ...
        <form class="space-y-5" method="POST" action="{{ route('enquiry.submit') }}">
            ...
            <div>
                <input type="text" name="pin_code" value="{{ old('pin_code') }}"
                       placeholder="Pin Code" min="100000" max="999999"  required id="pin_code2"
                       class="w-full border-b border-gray-300 focus:border-indigo-400 outline-none py-2
                                    {{ $errors->has('mobile') ? 'border-red-500 ring-red-300' : 'border-black/10' }}">
                @error('pin_code')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" method="post" action="{{route('apply.fren')}}">
                        ...
                        <div class="col-md-12">
                            <label for="location" class="form-label">Pin Code *</label>
...
<script>
    document.getElementById('pin_code').addEventListener('keyup', function () {
     ...
     document.getElementById('pin_code2').addEventListener('keyup', function () {
        const pincode = this.value;
        ...
        if (pincode.length === 6) {
            fetch(`https://api.postalpincode.in/pincode/${pincode}`)
                ...
                .then(data => {
                    if (data[0].Status === "Success") {
                        const postOffice = data[0].PostOffice[0];
                        document.getElementById('city2').value = postOffice.District;
                        document.getElementById('state2').value = postOffice.State;
                    } else {
