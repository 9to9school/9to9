            ...
            <div class="row p-3 align-items-center">
                ...
                <div class="col-md-6 text-center text-md-start">
                    ...
                    <div class="d-flex gap-2 justify-content-center justify-content-md-start mt-3">
                        <a href="{!! URL('talk-expert') !!}" class="btn btn-primary btn-custom">Apply Today</a>
...
<section class="secchildmil child-milestones py-8 py-4 custompadding-2em">
    <div class="container mx-auto">
        ...
        <p class="text-center sm:text-left text-muted w-[80%] m-auto mb-4">
            Our curriculum is carefully designed to support key developmental milestones at each age. 
            See how we nurture your child's growth through targeted learning experiences.
        </p>
            ...
            @foreach($milestones as $index => $milestone)
                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" id="tab-content-{{ $index }}" role="tabpanel">
                    ...
                    <div class="row justify-content-center mb-14">
                        <div class="col-md-7 d-flex mb-5">
                            <div class="frame-30 w-100 d-flex flex-column h-100">
                                    ...
                                    @foreach($topics as $num => $topic_id)
                                        ...
                                        @if($get_topic)
                                            <li class="mb-2 d-flex align-items-start">
                                                <div class="frame-34 me-2">
                                                    <span class="text-wrapper-15">{{ $num + 1 }}</span>
                                                </div>
                        ...
                        <div class="col-md-5 d-flex">
                            <div class="frame-35 w-100 d-flex flex-column justify-content-center align-items-center text-center h-100">
                    ...
                    <div class="swiper-slide h-full eventsec flex">
                        <div class="flex flex-col bg-white rounded-lg border shadow overflow-hidden w-full h-full">
                            <div class="h-[200px] overflow-hidden">
                                <img src="{!! asset($event->image) !!}" class="w-full h-full object-cover p-2" alt="Storytelling">
                            </div>
                            <div class="flex flex-col justify-between flex-1 p-4">
                                <div>
                                    <h6 class="text-lg font-semibold">{!! ucfirst($row->title) !!}</h6>
                                    <p class="text-sm mt-1">{!! ucfirst($row->description) !!}</p>
                                </div>
                                <div class="mt-4">
                                    <a href="{{ url('/life-skills') }}" target="_blank"
                                       class="inline-block w-full text-center bg-[#571D99] hover:bg-[#760af1] text-white text-sm px-4 py-2 rounded hover:bg-opacity-90 transition">
                                        Learn more
                                    </a>
                                </div>
