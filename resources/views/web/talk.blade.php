...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  @section('content')
<div class="expert-form text-center bg-cover bg-center" style="background-image: url('https://img.freepik.com/premium-photo/kindergarten-preschool-colorful-banner-with-empty-copy-space-background_800563-2774.jpg');">
  ...
  <form action="{{ route('talk.expert.submit') }}" method="POST">
    ...
    <button type="submit" class="btn btn-pay w-100"> Connect</button>
  </form>
</div>
