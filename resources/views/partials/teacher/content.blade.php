                              ...
                              <div class="d-sm-flex align-items-center justify-content-between row-gap-3">
                                  <div class="d-flex align-items-center overflow-hidden mb-3">
                                      <div
                                          ...
                                          <img src="{{asset('assets-admin/img/teachers/teacher-01.jpg') }}" alt="Img">
                                      </div>
                                  ...
                                  <a href="#" class="btn btn-primary flex-shrink-0 mb-3">Edit
                                      Profile</a>
                              </div>
                              <div class="student-card-bg">
                                  <img src="{{asset('assets-admin/img/bg/circle-shape.png') }}" alt="Bg">
                                  <img src="{{asset('assets-admin/img/bg/shape-02.png') }}" alt="Bg">
                                  <img src="{{asset('assets-admin/img/bg/shape-04.png') }}" alt="Bg">
                                  <img src="{{asset('assets-admin/img/bg/blue-polygon.png') }}" alt="Bg">
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-xxl-6 col-xl-6 col-md-6 d-flex flex-column">
                      <div class="card">
                          <div class="card-header d-flex align-items-center justify-content-between">
                              ...
                              <a href="#" class="link-primary fw-medium">View All</a>
                          </div>
                          <div class="card-body pb-1">
                                              ...
                                              <div class="avatar-list-stacked avatar-group-xs d-flex">
                                                  <span class="avatar avatar-rounded">
                                                      <img class="border border-white"
                                                          src="{{asset('assets-admin/img/students/student-01.jpg') }}" alt="img">
                                                  </span>
                                                  <span class="avatar avatar-rounded">
                                                      <img class="border border-white"
                                                          src="{{asset('assets-admin/img/students/student-02.jpg') }}" alt="img">
                                                  </span>
                                                  <span class="avatar avatar-rounded">
                                                      <img src="{{asset('assets-admin/img/students/student-03.jpg') }}" alt="img">
                                                  </span>
                                              </div>
                                          </div>
                                      ...
                                      <div class="progress justify-content-between" role="progressbar"
                                          ...
                                          <div class="progress-bar bg-warning" style="width: 54%">
                                              <div class="avatar-list-stacked avatar-group-xs d-flex">
                                                  <span class="avatar avatar-rounded">
                                                      <img class="border border-white"
                                                          src="{{asset('assets-admin/img/profiles/avatar-27.jpg') }}" alt="img">
                                                  </span>
                                                  <span class="avatar avatar-rounded">
                                                      <img class="border border-white"
                                                          src="{{asset('assets-admin/img/students/student-05.jpg') }}" alt="img">
                                                  </span>
                                                  <span class="avatar avatar-rounded">
                                                      <img src="{{asset('assets-admin/img/students/student-06.jpg') }}" alt="img">
                                                  </span>
                                              </div>
                                          </div>
                                      ...
                                      <div class="progress justify-content-between" role="progressbar"
                                          ...
                                          <div class="progress-bar bg-skyblue" style="width: 76%">
                                              <div class="avatar-list-stacked avatar-group-xs d-flex">
                                                  ...
                                                  <span class="avatar avatar-rounded">
                                                      <img class="border border-white"
                                                          src="{{asset('assets-admin/img/students/student-06.jpg') }}" alt="img">
                                                  </span>
                                                  <span class="avatar avatar-rounded">
                                                      <img src="{{asset('assets-admin/img/students/student-05.jpg') }}" alt="img">
                                                  </span>
                                              </div>
                                          </div>
                      ...
                      <div class="card flex-fill">
                          ...
                          <div class="card-body">
                              <div
                                  ...
                                  <div class="d-flex align-items-center">
                                      <img src="{{ asset('assets/admin/img/icons/medal.svg')}}" alt="icon">
                              ...
                              <div
                                  ...
                                  <div class="d-flex align-items-center">
                                      <img src="{{ asset('assets/admin/img/icons/medal-2.svg')}}" alt="icon">
                                      <span class="badge badge-success ms-2">98%</span>
                                  </div>
                              </div>
                              <div
                      ...
                      <div class="event-scroll">
                              ...
                              <div class="d-flex align-items-center justify-content-between">
                                  ...
                                  <div class="avatar-list-stacked avatar-group-sm">
                                      <span class="avatar border-0">
                                          <img src="{{ asset('assets/admin/img/parents/parent-11.jpg')}}" class="rounded-circle"
                                              alt="img">
                                      </span>
                                      <span class="avatar border-0">
                                          <img src="{{ asset('assets/admin/img/parents/parent-13.jpg')}}" class="rounded-circle"
                                              alt="img">
                                      </span>
                                  </div>
                              </div>
                          ...
                          <div class="border-start border-skyblue border-3 shadow-sm p-3 mb-3">
                              ...
                              <div class="d-flex align-items-center justify-content-between">
                                  ...
                                  <div class="avatar-list-stacked avatar-group-sm">
                                      <span class="avatar border-0">
                                          <img src="{{ asset('assets/admin/img/parents/parent-01.jpg')}}" class="rounded-circle"
                                              alt="img">
                                      </span>
                                      <span class="avatar border-0">
                                          <img src="{{ asset('assets/admin/img/parents/parent-07.jpg')}}" class="rounded-circle"
                                              alt="img">
                                      </span>
                                      <span class="avatar border-0">
                                          <img src="{{ asset('assets/admin/img/parents/parent-02.jpg')}}" class="rounded-circle"
                                              alt="img">
                                      </span>
                                  </div>
                              </div>
                          ...
                          <div class="border-start border-info border-3 shadow-sm p-3 mb-3">
                              ...
                              <div class="d-flex align-items-center justify-content-between">
                                  ...
                                  <div class="avatar-list-stacked avatar-group-sm">
                                      <span class="avatar border-0">
                                          <img src="{{ asset('assets/admin/img/parents/parent-05.jpg')}}" class="rounded-circle"
                                              alt="img">
                                      </span>
                                      <span class="avatar border-0">
                                          <img src="{{ asset('assets/admin/img/parents/parent-06.jpg')}}" class="rounded-circle"
                                              alt="img">
                                      </span>
                                      <span class="avatar border-0">
                                          <img src="{{ asset('assets/admin/img/parents/parent-07.jpg')}}" class="rounded-circle"
