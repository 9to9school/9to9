        ...
        <div class="dropdown ms-1">
          <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
            <span class="avatar avatar-md rounded">
              <img src="{{ !empty(Auth::user()->avtar) ? asset(Auth::user()->avtar) : asset('assets/admin/img/profiles/avatar-27.jpg') }}" alt="Img" class="img-fluid">
            </span>
          </a>
            ...
            <div class="d-block">
              <div class="d-flex align-items-center p-2">
                <span class="avatar avatar-md me-2 online avatar-rounded">
                 <img src="{{ !empty(Auth::user()->avtar) ? asset(Auth::user()->avtar) : asset('assets/admin/img/profiles/avatar-27.jpg') }}" alt="img">

                </span>
                <div>
                  <h6 class="">{{ !empty(Auth::user()->name) ? Auth::user()->name : 'Admin' }}</h6>
              ...
              if(auth()->user()->role == 'admin' ){
                $editroute = url('admin/profile');
                 $logoutroute = url('admin/logout');
              
              }else{
               $editroute = url('marketing/profile');
                $logoutroute = url('admin/logout');
              }
              ?>
              <hr class="m-0">
              <a class="dropdown-item d-inline-flex align-items-center p-2" href="{{  $editroute }}">
              ...
              <hr class="m-0">
              <a class="dropdown-item d-inline-flex align-items-center p-2" href="{{  $logoutroute}}"><i
