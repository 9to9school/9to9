    ...
    <div class="max-w-2xl mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
        ...
        <div class="p-6">
            ...
            <p class="text-gray-700 mb-4">
                Thank you for reaching out to <strong>9to9school.com</strong> regarding admission. We truly appreciate your interest in our innovative and flexible learning platform.
            </p>
